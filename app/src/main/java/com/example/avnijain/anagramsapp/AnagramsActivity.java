package com.example.avnijain.anagramsapp;
...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "Find as many words as possible that can be formed" +
            " by adding one letter to <big>%s</big> (but that do not contain the substring <big>%s<big>).";
